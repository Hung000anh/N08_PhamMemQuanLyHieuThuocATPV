...
public class GD_TraSanPham1 extends JPanel {
	...
	public GD_TraSanPham1() {
		contentPane = new JPanel();
		contentPane.setSize(1140, 865);
		contentPane.setBackground(new Color(139, 136, 180));
		contentPane.setBorder(new EmptyBorder(5, 5, 5, 5));
		contentPane.setLayout(null);

		JPanel panel = new JPanel();
		panel.setBounds(10, 122, 1120, 85);
		...
		panel_1.setBounds(10, 217, 541, 628);
		...
		scrollpane.setBounds(0, 10, 521, 176);
		...
		panel_1_1.setBounds(561, 217, 569, 628);
		...
		scrollpane_1.setBounds(0, 0, 521, 126);
		...
		panel_4.setBounds(0, 0, 1140, 60);
		contentPane.add(panel_4);
		panel_4.setLayout(null);
		
		JLabel lblNewLabel_2 = new JLabel("TRẢ SẢN PHẨM");
		lblNewLabel_2.setFont(new Font("Arial", Font.BOLD, 24));
		lblNewLabel_2.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_2.setBounds(0, 0, 1140, 60);
