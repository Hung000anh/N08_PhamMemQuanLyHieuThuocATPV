...
public class GD_TrangChu1 extends JFrame implements ActionListener{
	...
	private final GD_TraSanPham traThuoc = new GD_TraSanPham();
	private JLabel backgound;

	private void initialize() {
		this.setSize(1540, 866);
//		setExtendedState(JFrame.1MAXIMIZED_BOTH);
		setUndecorated(true);
		...
		btnBanThuoc.setBounds(0, 140, 400, 60);
		...
		btnTraThuoc.setBounds(0, 220, 400, 60);
		...
		btnKhuyenMai.setBounds(0, 300, 400, 60);
		...
		btnNhanVien.setBounds(0, 380, 400, 60);
		...
		btnKhachHang.setBounds(0, 460, 400, 60);
		...
		btnSanPham.setBounds(0, 540, 400, 60);
		menu.add(btnSanPham);
		...
		btnHoaDon.setBounds(0, 620, 400, 60);
		menu.add(btnHoaDon);
		...
		btnThongKe.setBounds(0, 700, 400, 60);
		menu.add(btnThongKe);
		...
		btnTroGiup.setBounds(0, 780, 400, 60);
		menu.add(btnTroGiup);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(o == btnTrangChu) {
			...
			setVisibleFalse();
			resetBtnBackground();
			panel.add(traThuoc).setVisible(true);
